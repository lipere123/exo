...
parser.add_argument("--discovery-module", type=str, choices=["udp"], default="udp", help="Discovery module to use")
...
inference_engine_name = args.inference_engine or "tinygrad"
